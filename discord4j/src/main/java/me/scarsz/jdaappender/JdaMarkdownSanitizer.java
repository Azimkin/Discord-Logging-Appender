 ...
 *
 * This class was adapted from the JDA project.
 * Original source: https://github.com/discord-jda/JDA
 * Modified by Azimkin on 01.05.2025.
 */
 ...
 * @since  4.0.0
 */
public class JdaMarkdownSanitizer
{
    ...
    public JdaMarkdownSanitizer()
    {
        this.ignored = NORMAL;
        this.strategy = SanitizationStrategy.REMOVE;
    }

    public JdaMarkdownSanitizer(int ignored, @Nullable SanitizationStrategy strategy)
    {
     ...
     * @return The sanitized string
     *
     * @see    JdaMarkdownSanitizer#JdaMarkdownSanitizer()
     * @see    #withIgnored(int)
     */
    @NotNull
    public static String sanitize(@NotNull String sequence, @NotNull SanitizationStrategy strategy)
    {
        ...
        return new JdaMarkdownSanitizer().withStrategy(strategy).compute(sequence);
    }
    ...
    {
        return new JdaMarkdownSanitizer()
                .withIgnored(ignored)
    ...
    /**
     * Switches the used {@link net.dv8tion.jda.api.utils.JdaMarkdownSanitizer.SanitizationStrategy}.
     *
     * @param  strategy
     *         The new strategy
     *
     ...
     */
    @NotNull
    public JdaMarkdownSanitizer withStrategy(@NotNull SanitizationStrategy strategy)
    {
        Objects.requireNonNull(strategy, "Strategy");
     ...
     * <br>Example: {@code new JdaMarkdownSanitizer().withIgnored(JdaMarkdownSanitizer.BOLD | JdaMarkdownSanitizer.UNDERLINE).compute("Hello __world__!")}
     *
     * @param  ignored
     ...
     */
    @NotNull
    public JdaMarkdownSanitizer withIgnored(int ignored)
    {
        this.ignored |= ignored;
        return this;
    }
    ...
    private String handleRegion(int start, int end, @NotNull String sequence, int region)
    {
        ...
        switch (region)
        {
            ...
            case MONO_TWO:
                return resolved;
            default:
                return new JdaMarkdownSanitizer(ignored, strategy).compute(resolved);
        }
    }
     ...
     * <br>Uses the specified {@link me.scarsz.jdaappender.JdaMarkdownSanitizer.SanitizationStrategy} and
